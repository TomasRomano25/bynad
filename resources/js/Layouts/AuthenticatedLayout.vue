...
const allNavigation = [
    ...
    { name: 'Trabajos',        url: '/jobs',             icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
            ...
            <div class="flex flex-col flex-grow bg-white border-r border-gray-200/80 shadow-sm">
                ...
                <div class="border-t border-gray-100 p-4">
                    <div class="flex items-center gap-3 px-3 py-2">
                        <Link :href="route('profile.edit')" class="flex items-center gap-3 flex-1 min-w-0 rounded-lg hover:bg-gray-50 transition-colors -mx-1 px-1 py-1" title="Perfil y cotizacion del dolar">
